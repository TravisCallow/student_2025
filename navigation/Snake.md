...
<script>
    ...
    (function(){
        ...
        document.getElementById('snake').addEventListener("click",fullscreen)
        ...
        let showScreen = function(screen_opt){
            ...
            switch(screen_opt){
                ...
                case SCREEN_GAME_OVER:
                    ...
                    ctx.fillText("Press SPACE to continue",canvas.width/2,200);
                    ctx.fillText("Highscore: " + highscore,canvas.width/2,270);
        ...
        let activeDot = function(x, y){
            ctx.filter = 'invert(1)';
            drawBorder(x * BLOCK, y * BLOCK, BLOCK, BLOCK);
